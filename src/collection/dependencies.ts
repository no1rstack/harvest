...
export const TARGET_DEPENDENCY_RULES: TargetDependencyRule[] = [
  ...
  // ENNA identity fan-out — each discovered word/entity becomes a child Collection
  {
    id: 'email-discovers-username',
    source_type: 'email',
    relation: 'discovers',
  ...
  {
    id: 'person-discovers-organization',
    source_type: 'person',
    relation: 'discovers',
  ...
  {
    id: 'metadata-discovers-username',
    source_type: 'metadata',
    relation: 'discovers',
    target_type: 'username',
    workflow_template: 'identity',
